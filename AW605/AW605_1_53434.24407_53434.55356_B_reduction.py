...
importvla("AW605_AC050305.exp",
          vis='AW605_AC050305.ms')

myvis='AW605_AC050305.ms'
...
flagdata(vis=myvis, mode='manual', flagbackup=False,
         antenna='VA24,VA25', timerange='12:58:45.0',
         scan='21')
